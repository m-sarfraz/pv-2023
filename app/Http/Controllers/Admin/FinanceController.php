...
class FinanceController extends Controller
{
    ...
    public function summaryAppend(Request $request)
    {
        ...
        if (strpos($sql, 'where') !== false) {
            ...
            $sql_Current_receivables = $sql . " and finance_detail.process_status in('FFUP','RCVD') group by `id` ";
            $sql_overDue_receivables = $sql . " and finance_detail.process_status ='OVERDUE' group by `id` ";
            // $sql_unbilled = $sql . "  and endorsements.remarks='Unbilled'";
