                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="GENDER"
                                            ...
                                            <option value="" {{ $user->gender == null ? 'selected' : '' }} disabled>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-0">
                            ...
                            <select name="ENDORSEMENT_TYPE" id="endo_type" disabled=""
                                class="form-control border pl-0 arrow-3 h-px-20_custom w-100 font-size-4 d-flex align-items-center w-100">
                                <option value="" {{ $user->type == null ? 'selected' : '' }} disabled>Select Option
                                </option>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <select name="CAREER_LEVEL" disabled="" id="career"
                                class="form-control border pl-0 arrow-3 h-px-20_custom w-100 font-size-4 d-flex align-items-center w-100">
                                <option value="" {{ $user->career_endo == null ? 'selected' : '' }} disabled>Select
                                    Option</option>
                        ...
                        <div class="form-group mb-0">
                            <div class="form-group mb-0">
                                ...
                                <input type="date" name="DATE_ENDORSED" disabled="" id="endo_date" onchange="setDate()"
                                    class="form-control border h-px-20_custom" value="{{ $user->endi_date }}" />
                                <div>
                                    <small class="text-danger"></small>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-0">
                            ...
                            <select name="STATUS" id="status" disabled=""
                                class="form-control border pl-0 arrow-3 h-px-20_custom w-100 font-size-4 d-flex align-items-center w-100">
                                <option value="" {{ $user->status == null ? 'selected' : '' }} disabled>Select Option
                                </option>
                                @foreach ($status->options as $statusOptions)
                                    <option value="{{ $statusOptions->option_name }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-0">
                            ...
                            <select name="REMARKS_FOR_FINANCE" disabled="" id="remarks_for_finance"
                                ...
                                @endphp
                                <option value="" {{ $user->remarks_for_finance == null ? 'selected' : '' }} disabled>
                                    Select Option</option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-0">
                            ...
                            <select name="SITE" disabled="" id="site"
                                ...
                                <option value="" {{ $user->site == null ? 'selected' : '' }} disabled>Select Option
                                </option>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <select id="domain_endo" name="DOMAIN_ENDORSEMENT" onchange="endoDomainChange(this)"
                                    ...
                                    @foreach ($domainDrop as $domainOption)
                                        <option value="{{ $domainOption->id }}"
                                            {{ ($user->domain_endo != null ? $user->domain_endo == $domainOption->domain_name : '') ? 'selected' : '' }}>
                                            {{ $domainOption->domain_name }}</option>
                                    @endforeach
                                </select>
                                <div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <select disabled="" id="segment" name="SEGMENT"
                                    ...
                                    <option value="" {{ $user->segment_endo == null ? 'selected' : '' }} disabled>
                                        Select Option
                                    </option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="REMARKS" id="remarks_finance"
                                            class="form-control border pl-0 arrow-3 h-px-20_custom w-100 font-size-4 d-flex align-items-center w-100">
                                            <option value=""
                                                {{ $user->remarks_recruiter == null ? 'selected' : '' }} disabled>
                                            </option>
                                            @foreach ($remarks->options as $remarksOptions)
                                                <option value="{{ $remarksOptions->option_name }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="CLIENT_FINANCE" class="form-control border h-px-20_custom w-100"
                                            ...
                                            <option value="" {{ $user->client_finance == null ? 'selected' : '' }}
                                                disabled>Select
                                                Option</option>
                                            @foreach ($client->options as $clientOptions)
                                                <option value="{{ $clientOptions->option_name }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="CAREER_LEVEL_FINANCE" id="career_finance"
                                            ...
                                            <option value="" {{ $user->career_finance == null ? 'selected' : '' }}
                                                disabled>Select
                                                Option</option>
                                            @foreach ($careerLevel->options as $careerLevelOptions)
                                                <option value="{{ $careerLevelOptions->option_name }}"
