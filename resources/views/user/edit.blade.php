                                    ...
                                    <div class="row mb-xl-1 mb-9">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" {{ $user->agent == 1 ? 'checked' : '' }} name="agent"
                                                    value="1" class=" h-px-48" />
                                                Agent
                                                <input type="radio" {{ $user->agent == 0 ? 'checked' : '' }} name="agent"
                                                    value="0" class=" h-px-48" />
                                                Non-Agent
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-xl-1 mb-9 justify-content-center">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span id="span1" style="color:red" class="d-none">New & Confirm
                                                        password dont matches</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-xl-1 mb-9 justify-content-center">
