                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="row m-0" id="UserData_div">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <div class="w-100"
                                                                            ...
                                                                            <i class="bi bi-x-circle d-none"
                                                                                id="cross" onclick="emptyFileinput()"
                            ...
                            <div class="col-lg-6 paddingZero mtSM-4">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select name="REMARKS" id="remarks_finance"
                                                                        class="form-control border pl-0 arrow-3 h-px-20_custom w-100 font-size-4 d-flex align-items-center w-100">
                                                                        <option value="" class="selectedOption"
                                                                            selected disabled>
                                                                            Select Option</option>
                                                                        @foreach ($remarks->options as $remarksOptions)
                                                                            <option
                                ...
                                @if (Auth::user()->id == $candidateDetail->recruiter_id)
                                @can('edit-record')
                                    <button class="btn btn-primary mt-5 btn-md"
                                        onclick="UpdateRecord('{{ $candidateDetail->id . '-' . $candidateDetail->numberOfEndo }}')">Update</button>
                                @endcan
                            @else
                                <a type="button" href="{{ url('admin/data-entry') }}?id={{ $candidateDetail->id }}"
                                    class="btn btn-primary mt-5 btn-md">Tap</a>
                            @endif
                            @if (Auth::user()->type == 1)
                                <button class="btn btn-danger mt-5 btn-md" type="button"
                                    onclick="verifyDeleteRecord('{{ $candidateDetail->id . '-' . $candidateDetail->numberOfEndo . '-' . $candidateDetail->recruiter_id }}')">Delete
                                    Record</button>
                            @endif
                            </div>
