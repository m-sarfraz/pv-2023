...
@section('content')
    <div class="container-fluid">
        <div id="detailView">
            ...
            <p class="C-Heading pt-3 ml-3">Finance Reference:</p>
            <div class="card mb-3">
                <div id="detailView">
                    <p class="C-Heading pt-3 ml-3">Endorsement Details:</p>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="date" class="form-control users-input-S-C"
                                                    placeholder="Rev.." value="{{ $detail->onboardnig_date }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." value="{{ $detail->domain_endo }}" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." value="{{ $detail->remarks_for_finance }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-1">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="hires.." value="{{ $detail->site }}" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." value="{{ $detail->position_title }}" />
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-2 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." value="{{ $detail->code }}" name="code" />
                                            </div>
                                        </div>
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." oninput="remarksChange()" id="paymentTerm"
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" id="offered_salary"
                                                    class="form-control users-input-S-C" placeholder="hires.."
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." value="{{ $detail->replacement_for }}"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="date" class="w-100 users-input-S-C form-control"
                                                    placeholder="Rev.." id="dateDlvrd"
                                                    value="{{ $detail->date_delvrd }}" name="date_delvrd"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." readonly id="processStatus"
                                                    value="{{ $detail->process_status }}" name="process_status" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-1">
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="hires.." id="allowance" name="allowance"
                                        ...
                                        <div class="col-lg-2 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." id="vat" oninput="placementFeeCalculator()"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." id="credit_memo"
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="hires.." id="compensation"
                                                    oninput="placementFeeCalculator()" name="compensation"
                                        ...
                                        <div class="col-lg-2 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." oninput="placementFeeCalculator()" id="rate"
                                                    name="rate_per"
                                        ...
                                        <div class="col-lg-2 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." value="{{ $detail->or_number }}"
                                                    name="or_number" />
                                            </div>
                                        </div>
                                        <div class="col-lg-2 p-1">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." id="reprocessShare"
                                                    oninput="reprocessAmountCalculate()"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." name="reprocess_share"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." id="vccShare" oninput="vccShareCalcualte()"
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." id="ownerSharePercentage"
                                                    oninput="ownerShareCalculate()"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="Rev.." id="ownerAmount" readonly
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="total.." oninput="ctakeCalcualte()"
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="hires.." id="adjustment"
                                                    oninput="adjustmentCalculator()" name="adjustment"
                                        ...
                                        <div class="col-lg-3 p-1">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" class="form-control users-input-S-C"
                                                    placeholder="hires.." id="finalFee" readonly
                                        ...
                                        <input type="text" class="form-control users-input-S-C d-none"
                                            placeholder="Rev.." id="individualRevenue" name="ind_revenue"
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                @can('edit-finance-record')
                                                    <button type="button" id="update"
                                                        class="font-size-small ml-5 w-100 border-0 btn-00 p-0 m-0"><small>Update
                ...
                success: function(res) {
                    ...
                    if (res.success == true) {
                        ...
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
                            title: 'Finance Reference updated successfully',
                        ...
                        setTimeout(() => {
                            Swal.fire({
                                icon: 'warning',
                                text: "Would you like to close Tab now?",
                                type: 'warning',
