                        ...
                        <table id="recordTable" class="table">
                            <thead class="bg-light w-100">
                                <tr style="">
                                    ...
                                    <th class="ant-table-cell"">Educational Attainment
                                    </th>
                                    ...
                                    <th class="ant-table-cell"">Remarks For Finance
                                    </th>
    ...
    <script>
        ...
        function appendFilterOptions() {
            $.ajax({
                ...
                .done(function(res) {
                    ...
                    var fromOB_view = JSON.parse(localStorage.getItem('date_view'));
        ...
        window.onbeforeunload = function(event) {
            ...
            if (afterLifeStr == 'record' || afterLifeStr == 'search' || afterLifeStr == 'finance') {
                ...
                localStorage.setItem('date_view', JSON.stringify(date_ob));
            } else {
                localStorage.clear();
